...
export const aboutMe: AboutMe = {
  ...
  description:
    "I'm a final-year <a href='https://www.utdallas.edu/'>Master's student</a> at UT Dallas where I am fortunate to be supervised by <a href='https://personal.utdallas.edu/~coskunuz/'>Prof. Baris Coskunuzer</a>. I have a background in deep learning and artificial intelligence for predictive analytics and data analysis. My current work focuses on augmenting deep learning models with topological data analysis to improve classification accuracy in the domain of biomedical imaging. <br /> I'm currently looking for a full-time position as a Data Scientist, I have extensively used languages such as Python, SQL, and R and have experience using statistical methods and machine learning in my research. <br /> I have published and presented my work to a wide variety of audiences from Radiologists/Neuroscientists at UT Southwestern Medical Center, Research Scientists at UT Austin, industry experts from American Airlines/Honeywell, and my peers at UT Dallas. <br /> In my free time I enjoy playing games in which I was top rated in League of Legends (Grandmaster / 0.01% peak), Counter-Strike (FACEIT Level 10 / Top 1000 North America), and Hearthstone (Rank 1 Peak / 0.003%). I also enjoy travelling (my most recent trip was to Taiwan).",
