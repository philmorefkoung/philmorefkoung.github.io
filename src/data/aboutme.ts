...
export const aboutMe: AboutMe = {
  ...
  description: "I'm a Health Data Science Ph.D. student at <a href='https://www.utsouthwestern.edu/'>UT Southwestern Medical Center</a>. I previously did my MS/BS in Math/Data Science at <a href='https://www.utdallas.edu/'>UT Dallas</a> where I was fortunate to be advised by <a href='https://personal.utdallas.edu/~coskunuz/'>Prof. Baris Coskunuzer</a>. <br /><br /> My research interests lie in the intersection of computer vision techniques, machine learning algorithms, medical image analysis, and topological deep learning. More broadly speaking, I am interested in creating and applying ML methods to medical image analysis (segmentation, classification, reconstruction). <br /><br /> In my free time I enjoy playing video games and travelling. Some games I was top rated in are: League of Legends (Grandmaster), Counter-Strike (FACEIT Level 10), and Hearthstone (Rank 1).",
